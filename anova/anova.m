...
function[m, n] = anova(n)

%load data
load('data_ignore.mat')
load('data.mat')
%switch for measures
test = n;
...
runID = {'Run1 - notignore', 'Run2 - notignore', 'Run3 - notignore', 'Run4 - notignore', 'Run1 - ignore', 'Run2 - ignore', 'Run3 - ignore', 'Run4 - ignore'};
